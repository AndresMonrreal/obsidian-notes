...
- [[XSS-Cross-Site-Scripting]] — Reflected/Stored/DOM/Blind, robo de cookies, keylogger, payloads por contexto (atributo/textarea/JS string), bypass de filtros, polyglots, XSS vs CSRF
